...
class CCommentInSession 
{
     ...
     *
     */
    private $options  = [];  // Options for behavior, set through constructor.
    private $comments = [];  // Holder for all comments once loaded.
    private $data     = [];  // Holder for one active comment or new comment to create.
    ...
    {
        $this->comments = isset($_SESSION[$this->options['session-key']]['comments']) 
            ? $_SESSION[$this->options['session-key']]['comments'] 
            : [];
        return $this;
    }
